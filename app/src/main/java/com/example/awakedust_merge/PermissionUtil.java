...
/**
 * Created by rlarh on 2018-04-30.
 */
...
public class PermissionUtil {
    ...
    public static int checkSelfPermission(@NonNull Context context, @NonNull String permission) throws IllegalAccessException {
        if(permission == null) {
    ...
    public static void requestFineLocationPermissions(final @NonNull Activity activity, final @NonNull String[] permissions, final int requestCode) {
